...
var coords = [
    ["kavya",     900,250],  // andhra
    ["tiara",     350, 45],  // calcutta
    ["natasha-ka", 530, 45],  // colombo
    ["maimuna",   675, 475],  // dhaka
    ["ravi",      65, 600],  // gujarat
    // ["danish",    330, 360],  // karachi
    ["natasha-kw",250, 400],  // lahore
    ["arushi",    500, 925],  // rajasthan
    ["iris",      750, 850],  // tamil nadu
];
...
function headerReplaceText() {
    $('header > .vertically-center').html("<h2>Click dots on the map to hear the<br>thoughts of students and teachers<br>about the new law</h2><br><h2><i class='fa fa-hand-o-up' aria-hidden='true'></i> Click Anywhere</h2>");
